...
const fights = [
  { id:1, card:"PRELIMS", time:"12:00", rounds:3, wc:"Bantamweight W", lbs:"135 lbs", ou:2.5,
    f1:{name:"M. Mullins",full:"Melissa Mullins",country:"USA",record:"7-2",age:34,odds:-130,ucfFights:5,
        slpm:3.71,sapm:4.39,sacc:50,sdef:52,td:2.03,tdacc:42,tddef:85,sub:0.0,
        ko:2,dec:4,s:1,reach:68,layoff:272,
        recentForm:[{r:"L",opp:"Zhelezniakova",oppRank:99,method:"DEC"},{r:"W",opp:"Sygula",oppRank:99,method:"KO"},{r:"L",opp:"Cornolle",oppRank:99,method:"KO"},{r:"W",opp:"Alekseeva",oppRank:99,method:"DEC"},{r:"W",opp:"opp",oppRank:99,method:"DEC"}],
        lossTypes:{ko:1,sub:0,dec:1},rank:99},
    f2:{name:"L. Carolina",full:"Luana Carolina",country:"BRA",record:"11-5",age:32,odds:108,ucfFights:8,
        slpm:4.65,sapm:3.46,sacc:51,sdef:51,td:0.30,tdacc:37,tddef:68,sub:0.6,
        ko:3,dec:7,s:1,reach:69,layoff:175,
  ...
  { id:2, card:"PRELIMS", time:"12:20", rounds:3, wc:"Strawweight W", lbs:"115 lbs", ou:2.5,
    f1:{name:"S. Dyer",full:"Shanelle Dyer",country:"USA",record:"6-1",age:24,odds:-145,ucfFights:1,
        slpm:5.5,sapm:5.5,sacc:41,sdef:44,td:0.0,tdacc:0,tddef:0,sub:0.0,
        ko:2,dec:3,s:1,reach:65,layoff:188,
    ...
    f2:{name:"R. Oliveira",full:"Ravena Oliveira",country:"BRA",record:"7-3-1",age:28,odds:120,ucfFights:3,
        slpm:1.40,sapm:2.80,sacc:29,sdef:50,td:1.08,tdacc:66,tddef:50,sub:0.0,
        ko:1,dec:5,s:1,reach:65,layoff:150,
  ...
  { id:3, card:"PRELIMS", time:"12:40", rounds:3, wc:"Lightweight", lbs:"155 lbs", ou:2.5,
    f1:{name:"S. Rock",full:"Shem Rock",country:"CAN",record:"12-2-1",age:31,odds:100,ucfFights:2,
        slpm:2.93,sapm:3.40,sacc:42,sdef:56,td:1.00,tdacc:11,tddef:80,sub:0.0,
        ko:2,dec:9,s:1,reach:73,layoff:119,
    ...
    f2:{name:"A. Al-Selwady",full:"Abdul-Kareem Al-Selwady",country:"PAL",record:"15-4",age:30,odds:-120,ucfFights:2,
        slpm:4.14,sapm:3.60,sacc:34,sdef:59,td:2.32,tdacc:30,tddef:20,sub:0.0,
        ko:5,dec:8,s:2,reach:69,layoff:383,
  ...
  { id:4, card:"PRELIMS", time:"13:40", rounds:3, wc:"Heavyweight", lbs:"265 lbs", ou:1.5,
    f1:{name:"M. Pinto",full:"Mario Pinto",country:"PRT",record:"11-0",age:27,odds:-600,ucfFights:3,
    ...
    f2:{name:"F. Franco",full:"Felipe Franco",country:"BRA",record:"8-1",age:24,odds:450,ucfFights:1,
        slpm:2.23,sapm:2.84,sacc:71,sdef:35,td:4.5,tdacc:40,tddef:100,sub:0.0,
        ko:3,dec:4,s:1,reach:76,layoff:188,
  ...
  { id:5, card:"PRELIMS", time:"13:20", rounds:3, wc:"Middleweight", lbs:"185 lbs", ou:1.5,
    f1:{name:"M. Kondratavicius",full:"Mantas Kondratavicius",country:"LTU",record:"8-1",age:25,odds:-600,ucfFights:1,
        slpm:4.55,sapm:3.64,sacc:33,sdef:60,td:4.5,tdacc:100,tddef:0,sub:0.0,
        ko:4,dec:3,s:1,reach:75,layoff:175,
        ...
        lossTypes:{ko:0,sub:0,dec:1},rank:99},
    f2:{name:"A. Trocoli",full:"Antonio Trocoli",country:"BRA",record:"12-6",age:34,odds:450,ucfFights:4,
        slpm:1.37,sapm:5.55,sacc:50,sdef:24,td:0.79,tdacc:10,tddef:33,sub:0.8,
        ko:2,dec:4,s:4,reach:80,layoff:100,
        recentForm:[{r:"L",opp:"Abdul-Malik",oppRank:99,method:"SUB"},{r:"L",opp:"Gore",oppRank:99,method:"SUB"},{r:"L",opp:"Magomedov",oppRank:99,method:"KO"},{r:"W",opp:"opp",oppRank:99,method:"DEC"},{r:"W",opp:"opp",oppRank:99,method:"SUB"}],
        lossTypes:{ko:2,sub:3,dec:1},rank:99}},
  { id:6, card:"PRELIMS", time:"13:00", rounds:3, wc:"Heavyweight", lbs:"265 lbs", ou:1.5,
    f1:{name:"L. Sutherland",full:"Louie Sutherland",country:"GBR",record:"10-4",age:31,odds:210,ucfFights:2,
        slpm:2.14,sapm:3.57,sacc:60,sdef:0,td:0.0,tdacc:0,tddef:0,sub:0.0,
        ko:4,dec:5,s:1,reach:76,layoff:142,
    ...
    f2:{name:"B. Pericic",full:"Brando Pericic",country:"HRV",record:"5-1",age:30,odds:-260,ucfFights:1,
        slpm:5.5,sapm:1.57,sacc:59,sdef:66,td:0.0,tdacc:0,tddef:100,sub:0.0,
        ko:4,dec:1,s:0,reach:79,layoff:175,
        ...
        lossTypes:{ko:0,sub:0,dec:1},rank:99}},
  { id:7, card:"PRELIMS", time:"14:20", rounds:3, wc:"Lightweight", lbs:"155 lbs", ou:2.5,
    f1:{name:"M. Jones",full:"Mason Jones",country:"GBR",record:"17-2",age:30,odds:-145,ucfFights:7,
    ...
    f2:{name:"A. Sola",full:"Axel Sola",country:"FRA",record:"11-0-1",age:27,odds:121,ucfFights:1,
