...
const fights = [
  { id:1, card:"PRELIMS", time:"16:00", rounds:3, wc:"Strawweight W", lbs:"115 lbs", ou:2.5,
    f1:{name:"P. Rodriguez",full:"Piera Rodriguez",country:"VEN",record:"11-2",age:33,odds:-165,
        slpm:3.54,sapm:2.81,sacc:47,sdef:55,td:4.53,tdacc:54,tddef:73,sub:0.0,
        ko:2,dec:7,s:2,reach:63,layoff:224,
        recentForm:[{r:"W",opp:"K.Souza",oppRank:99,method:"DEC"},{r:"W",opp:"Knutsson",oppRank:99,method:"DEC"},{r:"L",opp:"Carnelossi",oppRank:99,method:"DQ"},{r:"L",opp:"Robertson",oppRank:8,method:"SUB"},{r:"W",opp:"Hansen",oppRank:99,method:"DEC"}],
        lossTypes:{ko:0,sub:1,dec:1},rank:99},
    f2:{name:"S. Hughes",full:"Sam Hughes",country:"USA",record:"11-6",age:33,odds:140,
        slpm:4.34,sapm:4.44,sacc:46,sdef:58,td:1.23,tdacc:35,tddef:60,sub:0.2,
        ko:1,dec:7,s:3,reach:64,layoff:196,
        recentForm:[{r:"W",opp:"Bannon",oppRank:99,method:"SUB"},{r:"W",opp:"Luciano",oppRank:99,method:"DEC"},{r:"W",opp:"Dudakova",oppRank:99,method:"DEC"},{r:"L",opp:"Jauregui",oppRank:99,method:"DEC"},{r:"W",opp:"Amorim",oppRank:99,method:"DEC"}],
        lossTypes:{ko:0,sub:1,dec:5},rank:99}},
  { id:2, card:"PRELIMS", time:"16:20", rounds:3, wc:"Bantamweight", lbs:"135 lbs", ou:2.5,
    f1:{name:"L. Lacerda",full:"Luan Luiz Lacerda",country:"BRA",record:"13-3",age:32,odds:-162,
        slpm:4.02,sapm:5.79,sacc:46,sdef:46,td:2.29,tdacc:41,tddef:66,sub:0.9,
        ko:5,dec:4,s:4,reach:71,layoff:154,
        recentForm:[{r:"W",opp:"S.Oliveira",oppRank:99,method:"SUB"},{r:"L",opp:"Blackshear",oppRank:99,method:"KO"},{r:"L",opp:"Stamann",oppRank:99,method:"DEC"},{r:"W",opp:"Sosa",oppRank:99,method:"KO"},{r:"W",opp:"Durden",oppRank:99,method:"KO"}],
        lossTypes:{ko:2,sub:0,dec:1},rank:99},
    f2:{name:"H. Sosa",full:"Hecher Sosa",country:"ESP",record:"14-1",age:29,odds:225,
        slpm:2.13,sapm:0.87,sacc:50,sdef:55,td:4.00,tdacc:36,tddef:100,sub:2.0,
        ko:0,dec:1,s:13,reach:70,layoff:179,
        recentForm:[{r:"W",opp:"M.Lee",oppRank:99,method:"DEC"},{r:"W",opp:"opponent",oppRank:99,method:"SUB"},{r:"W",opp:"opponent",oppRank:99,method:"SUB"},{r:"W",opp:"opponent",oppRank:99,method:"SUB"},{r:"L",opp:"Lacerda",oppRank:99,method:"KO"}],
        lossTypes:{ko:1,sub:0,dec:0},rank:99}},
  { id:3, card:"PRELIMS", time:"16:40", rounds:3, wc:"Bantamweight W", lbs:"135 lbs", ou:2.5,
    f1:{name:"B. Mesquita",full:"Beatriz Mesquita",country:"BRA",record:"6-0",age:34,odds:-550,
        slpm:3.20,sapm:1.80,sacc:52,sdef:65,td:2.80,tdacc:58,tddef:78,sub:2.4,
        ko:1,dec:0,s:4,reach:64,layoff:154,
        recentForm:[{r:"W",opp:"Alekseeva",oppRank:99,method:"SUB"},{r:"W",opp:"LFA opp",oppRank:99,method:"SUB"},{r:"W",opp:"LFA opp",oppRank:99,method:"KO"},{r:"W",opp:"LFA opp",oppRank:99,method:"SUB"},{r:"W",opp:"Ramos",oppRank:99,method:"SUB"}],
        lossTypes:{ko:0,sub:0,dec:0},rank:99},
    f2:{name:"M. Rendon",full:"Montserrat Rendon",country:"MEX",record:"7-1",age:36,odds:400,
        slpm:3.09,sapm:3.42,sacc:28,sdef:59,td:2.00,tdacc:37,tddef:100,sub:0.3,
        ko:0,dec:5,s:2,reach:68,layoff:182,
        recentForm:[{r:"W",opp:"A.Pereira",oppRank:99,method:"DEC"},{r:"L",opp:"Zhelezniakova",oppRank:99,method:"DEC"},{r:"W",opp:"Vidal",oppRank:99,method:"DEC"},{r:"W",opp:"Hughes",oppRank:99,method:"DEC"},{r:"W",opp:"Kassem",oppRank:99,method:"SUB"}],
        lossTypes:{ko:0,sub:0,dec:1},rank:99}},
  { id:4, card:"PRELIMS", time:"17:00", rounds:3, wc:"Middleweight", lbs:"185 lbs", ou:2.5,
    f1:{name:"B. Tavares",full:"Brad Tavares",country:"USA",record:"21-12",age:37,odds:200,
        slpm:3.42,sapm:3.36,sacc:43,sdef:54,td:0.73,tdacc:26,tddef:81,sub:0.0,
        ko:7,dec:13,s:1,reach:74,layoff:189,
        recentForm:[{r:"L",opp:"Bryczek",oppRank:99,method:"KO"},{r:"W",opp:"Meerschaert",oppRank:99,method:"DEC"},{r:"L",opp:"J.Park",oppRank:99,method:"DEC"},{r:"L",opp:"Rodrigues",oppRank:99,method:"KO"},{r:"W",opp:"Weidman",oppRank:99,method:"DEC"}],
        lossTypes:{ko:5,sub:1,dec:6},rank:99},
    f2:{name:"E. Anders",full:"Eryk Anders",country:"USA",record:"17-9",age:37,odds:-183,
        slpm:3.51,sapm:4.09,sacc:48,sdef:50,td:1.75,tdacc:24,tddef:80,sub:0.1,
        ko:9,dec:5,s:3,reach:75,layoff:217,
        recentForm:[{r:"L",opp:"Duncan",oppRank:99,method:"KO"},{r:"W",opp:"Weidman",oppRank:99,method:"KO"},{r:"W",opp:"Pickett",oppRank:99,method:"DEC"},{r:"L",opp:"Barriault",oppRank:99,method:"DEC"},{r:"W",opp:"Daukaus",oppRank:99,method:"KO"}],
        lossTypes:{ko:4,sub:2,dec:3},rank:99}},
  { id:5, card:"PRELIMS", time:"17:20", rounds:3, wc:"Lightweight", lbs:"155 lbs", ou:2.5,
    f1:{name:"B. Oki",full:"Bolaji Oki",country:"BEL",record:"10-3",age:29,odds:125,
        slpm:6.59,sapm:5.15,sacc:44,sdef:61,td:1.01,tdacc:60,tddef:66,sub:0.0,
        ko:5,dec:4,s:1,reach:73,layoff:189,
        recentForm:[{r:"L",opp:"M.Jones",oppRank:99,method:"KO"},{r:"W",opp:"Aswell Jr",oppRank:99,method:"DEC"},{r:"L",opp:"C.Duncan",oppRank:99,method:"SUB"},{r:"W",opp:"Cuamba",oppRank:99,method:"DEC"},{r:"W",opp:"Salvador",oppRank:99,method:"KO"}],
        lossTypes:{ko:1,sub:1,dec:1},rank:99},
    f2:{name:"M. Sousa",full:"Manoel Sousa",country:"BRA",record:"13-1",age:27,odds:-137,
        slpm:3.23,sapm:1.31,sacc:58,sdef:55,td:0.00,tdacc:0,tddef:62,sub:2.3,
        ko:2,dec:2,s:9,reach:70,layoff:196,
        recentForm:[{r:"W",opp:"C.Perez",oppRank:99,method:"KO"},{r:"W",opp:"opp",oppRank:99,method:"SUB"},{r:"W",opp:"opp",oppRank:99,method:"SUB"},{r:"W",opp:"opp",oppRank:99,method:"SUB"},{r:"L",opp:"opp",oppRank:99,method:"DEC"}],
        lossTypes:{ko:0,sub:0,dec:1},rank:99}},
  { id:6, card:"PRELIMS", time:"17:40", rounds:3, wc:"Bantamweight", lbs:"135 lbs", ou:2.5,
    f1:{name:"E. Smith",full:"Elijah Smith",country:"USA",record:"9-1",age:22,odds:-176,
        slpm:4.45,sapm:3.40,sacc:47,sdef:47,td:3.51,tdacc:53,tddef:57,sub:0.9,
        ko:3,dec:4,s:2,reach:71,layoff:217,
        recentForm:[{r:"W",opp:"Kazama",oppRank:99,method:"KO"},{r:"W",opp:"Morales",oppRank:99,method:"DEC"},{r:"W",opp:"A.Tau",oppRank:99,method:"DEC"},{r:"W",opp:"opp",oppRank:99,method:"KO"},{r:"L",opp:"opp",oppRank:15,method:"DEC"}],
        lossTypes:{ko:0,sub:0,dec:1},rank:99},
    f2:{name:"S. You",full:"SuYoung You",country:"KOR",record:"16-3",age:29,odds:200,
        slpm:2.28,sapm:1.96,sacc:46,sdef:70,td:3.80,tdacc:47,tddef:66,sub:0.4,
        ko:1,dec:10,s:5,reach:65,layoff:112,
        recentForm:[{r:"W",opp:"X.Long",oppRank:99,method:"DEC"},{r:"W",opp:"Cunningham",oppRank:99,method:"DEC"},{r:"W",opp:"Jieleyisi",oppRank:99,method:"DEC"},{r:"W",opp:"Zhawupasi",oppRank:99,method:"DEC"},{r:"W",opp:"opp",oppRank:99,method:"DEC"}],
