...
const fights = [
  ...
  { id:8, card:"MAIN CARD", time:"20:20", rounds:3, wc:"Welterweight", lbs:"170 lbs", ou:2.5,
    f1:{name:"C. Curtis",full:"Chris Curtis",country:"USA",record:"32-10",age:36,odds:-175,slpm:5.1,sapm:4.3,sacc:48,sdef:58,td:0.3,tdacc:20,tddef:81,sub:0.0,ko:17,dec:13,s:2,avgFightTime:11.8,reach:73,layoff:95,recentForm:[{r:"W",opp:"Nelson",oppRank:99,method:"DEC"},{r:"W",opp:"Brady",oppRank:6,method:"DEC"},{r:"L",opp:"Maddalena",oppRank:3,method:"KO"},{r:"W",opp:"Buckley",oppRank:8,method:"DEC"},{r:"W",opp:"Barriault",oppRank:99,method:"KO"}],lossTypes:{ko:3,sub:2,dec:5},rank:99},
  ...
  return(
    <div style={{background:"#f8f9fa",borderRadius:8,padding:"10px 12px",marginTop:6}}>
      ...
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
        ...
        <span style={{fontSize:8,fontFamily:"monospace",color:"#aaa"}}>Est: <strong style={{color:"#555"}}>{estTime.toFixed(1)} min</strong></span>
      </div>
    </div>
  );
}
              ...
              {[f1,f2].map((f,i)=>(
                <div key={i} style={{flex:1,background:"#f8f9fa",borderRadius:6,padding:"8px 10px"}}>
                  ...
                  <div style={{marginTop:5,fontSize:7,fontFamily:"monospace",color:"#bbb"}}>
                    Defaites KO:{f.lossTypes.ko} SUB:{f.lossTypes.sub} DEC:{f.lossTypes.dec}
                  </div>
                  <div style={{marginTop:3,fontSize:7,fontFamily:"monospace",color:"#bbb"}}>
                    Avg:{f.avgFightTime}min Reach:{f.reach}"
                  </div>
                </div>
              ))}
            </div>
    ...
    <div style={{background:"#f0f2f5",minHeight:"100vh",fontFamily:"system-ui,sans-serif"}}>
      ...
      <div style={{background:"#fff",borderTop:"1px solid #e8e8e8",padding:"12px 16px"}}>
        ...
        <div style={{display:"flex",flexWrap:"wrap",gap:5}}>
          {["Striking Net","Grappling","Forme recente","Style matchup","Age penalty","Layoff penalty","Reach adv","Chin vulnerability","Avg fight time","Finish pressure"].map(v=>(
